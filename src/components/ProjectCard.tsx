...
export default function ProjectCard({id, title, description, stack, imageUrl, projectUrl}: {id: number, title: string, description: string, stack: string[], imageUrl: string, projectUrl: string}) {
    return (
        <div className={`lg:w-6xl lg:h-[480px] md:w-[784px] md:h-[360px] w-xl h-[772px] shadow-lg rounded-lg flex ${id % 2 !== 0 ? "lg:flex-row md:flex-row flex-col" : "lg:flex-row-reverse md:flex-row-reverse flex-col"}`}>
